...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ClinicalStaffNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleNotFound(ClinicalStaffNotFoundException ex) {
        return build(HttpStatus.NOT_FOUND, ex.getMessage(), null);
    }

    @ExceptionHandler(LicenseAlreadyExistsException.class)
    public ResponseEntity<Map<String, Object>> handleDuplicateLicense(LicenseAlreadyExistsException ex) {
        return build(HttpStatus.CONFLICT, ex.getMessage(), null);
    }

    @ExceptionHandler(InvalidStaffDataException.class)
    public ResponseEntity<Map<String, Object>> handleInvalidData(InvalidStaffDataException ex) {
